...
export async function POST(request: NextRequest) {
  try {
    ...
    const output: Output = {
      ...
      selected_visual_index: updatedDbOutput.selected_visual_index || 0,
